...
/**
 * Returns the meaning extracted from an audio stream from the microphone using sox
 * @param access_token your access token from your instance settings page
 * @param [options] json object to be passed to wit. Can include any of 'context', 'verbose', 'n'
 * @param callback callback that takes 2 arguments err and the response body
 * @return stream microphone stream that can be stopped manually
 */
...
// Return stream so it can be manually/forcefully stopped
    return record;
...
module.exports.captureSpeechIntentFromMic = captureSpeechIntentFromMic;
